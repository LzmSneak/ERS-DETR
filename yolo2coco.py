...
parser.add_argument('--image_path', default='E:/DataSets/VisDrone2019/images/val',type=str, help="path of images")
parser.add_argument('--label_path', default='E:/DataSets/VisDrone2019/labels/val',type=str, help="path of labels .txt")
